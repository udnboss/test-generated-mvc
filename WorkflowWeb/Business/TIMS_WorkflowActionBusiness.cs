...
{
    public class TIMS_WorkflowActionBusiness : BaseBusiness<TIMS_WorkflowAction>
    {
        ...
        private IQueryable<TIMS_WorkflowAction> GetIQueryable(TIMS_WorkflowAction filter)
        {
