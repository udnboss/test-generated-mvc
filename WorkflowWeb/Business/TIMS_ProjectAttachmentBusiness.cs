...
{
    public class TIMS_ProjectAttachmentBusiness : BaseBusiness<TIMS_ProjectAttachment>
    {
        ...
        private IQueryable<TIMS_ProjectAttachment> GetIQueryable(TIMS_ProjectAttachment filter)
        {
