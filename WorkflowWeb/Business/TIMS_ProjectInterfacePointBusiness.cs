...
{
    public class TIMS_ProjectInterfacePointBusiness : BaseBusiness<TIMS_ProjectInterfacePoint>
    {
        ...
        private IQueryable<TIMS_ProjectInterfacePoint> GetIQueryable(TIMS_ProjectInterfacePoint filter)
        {
