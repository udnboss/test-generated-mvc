...
{
    public class TIMS_ProjectActionItemWorkflowBusiness : BaseBusiness<TIMS_ProjectActionItemWorkflow>
    {
        ...
        private IQueryable<TIMS_ProjectActionItemWorkflow> GetIQueryable(TIMS_ProjectActionItemWorkflow filter)
        {
