...
{
    public class TIMS_ProjectPackageBusiness : BaseBusiness<TIMS_ProjectPackage>
    {
        ...
        private IQueryable<TIMS_ProjectPackage> GetIQueryable(TIMS_ProjectPackage filter)
        {
