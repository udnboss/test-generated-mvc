...
{
    public class TIMS_ProjectInterfaceAgreementBusiness : BaseBusiness<TIMS_ProjectInterfaceAgreement>
    {
        ...
        private IQueryable<TIMS_ProjectInterfaceAgreement> GetIQueryable(TIMS_ProjectInterfaceAgreement filter)
        {
