...
{
    public partial class TIMS_UserController : BaseController<TIMS_User, TIMS_UserBusiness, TIMS_UserViewModel>
    {
        public TIMS_UserController()
        {
            business = new TIMS_UserBusiness(db, user);
        ...
        public ActionResult List(Guid? id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_UserViewModel(x, true)).ToList();
        ...
        {
            var routeFilter = GetRouteFilter();
            var vm = routeFilter != null ? new TIMS_UserViewModel(routeFilter) : new TIMS_UserViewModel() { };
        ...
        public ActionResult Create(TIMS_UserViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_UserViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_UserViewModel vm, bool json = false)
        {
            string message;
