...
namespace WorkflowWeb.Controllers
{
    public partial class TIMS_ProjectContractorController : BaseController<TIMS_ProjectContractor, TIMS_ProjectContractorBusiness, TIMS_ProjectContractorViewModel>
    {
        ...
        public ActionResult Create(TIMS_ProjectContractorViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_ProjectContractorViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_ProjectContractorViewModel vm, bool json = false)
        {
            string message;
