...
{
    public partial class TIMS_WorkflowActionController : BaseController<TIMS_WorkflowAction, TIMS_WorkflowActionBusiness, TIMS_WorkflowActionViewModel>
    {
        public TIMS_WorkflowActionController()
        {
            business = new TIMS_WorkflowActionBusiness(db, user);
        ...
        public ActionResult List(String id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_WorkflowActionViewModel(x, true)).ToList();
        ...
        {
            var routeFilter = GetRouteFilter();
            var vm = routeFilter != null ? new TIMS_WorkflowActionViewModel(routeFilter) : new TIMS_WorkflowActionViewModel() { };
        ...
        public ActionResult Create(TIMS_WorkflowActionViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_WorkflowActionViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_WorkflowActionViewModel vm, bool json = false)
        {
            string message;
