...
namespace WorkflowWeb.Controllers
{
    public partial class TIMS_ProjectDisciplineInterfaceTypeController : BaseController<TIMS_ProjectDisciplineInterfaceType, TIMS_ProjectDisciplineInterfaceTypeBusiness, TIMS_ProjectDisciplineInterfaceTypeViewModel>
    {
        ...
        public ActionResult List(Guid? id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_ProjectDisciplineInterfaceTypeViewModel(x, true)).ToList();
        ...
        public ActionResult Create(TIMS_ProjectDisciplineInterfaceTypeViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_ProjectDisciplineInterfaceTypeViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_ProjectDisciplineInterfaceTypeViewModel vm, bool json = false)
        {
            string message;
