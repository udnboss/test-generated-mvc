...
namespace WorkflowWeb.Controllers
{
    public partial class TIMS_ProjectInterfacePointController : BaseController<TIMS_ProjectInterfacePoint, TIMS_ProjectInterfacePointBusiness, TIMS_ProjectInterfacePointViewModel>
    {
        ...
        public ActionResult List(Guid? id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_ProjectInterfacePointViewModel(x, true)).ToList();
        ...
        public ActionResult Create(TIMS_ProjectInterfacePointViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_ProjectInterfacePointViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_ProjectInterfacePointViewModel vm, bool json = false)
        {
            string message;
