...
{
    public partial class TIMS_ContractorController : BaseController<TIMS_Contractor, TIMS_ContractorBusiness, TIMS_ContractorViewModel>
    {
        public TIMS_ContractorController()
        {
            business = new TIMS_ContractorBusiness(db, user);
        ...
        public ActionResult List(Guid? id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_ContractorViewModel(x, true)).ToList();
        ...
        public ActionResult Create(TIMS_ContractorViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_ContractorViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_ContractorViewModel vm, bool json = false)
        {
            string message;
