...
{
    public partial class T_DomainController : BaseController<T_Domain, T_DomainBusiness, T_DomainViewModel>
    {
        public T_DomainController()
        {
            business = new T_DomainBusiness(db, user);
        ...
        public ActionResult List(String id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new T_DomainViewModel(x, true)).ToList();
        ...
        public ActionResult Details(String id, bool partial = true, bool json = false)
        {
            ...
            else
            {
                ...
                {
                    var m = r.Data;
                    var vm = new T_DomainViewModel(m, true);
        ...
        {
            var routeFilter = GetRouteFilter();
            var vm = routeFilter != null ? new T_DomainViewModel(routeFilter) : new T_DomainViewModel() { };
        ...
        public ActionResult Create(T_DomainViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(T_DomainViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(T_DomainViewModel vm, bool json = false)
        {
            string message;
