...
{
    public partial class T_UploadController : BaseController<T_Upload, T_UploadBusiness, T_UploadViewModel>
    {
        public T_UploadController()
        {
            business = new T_UploadBusiness(db, user);
        ...
        public ActionResult List(Guid? id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new T_UploadViewModel(x, true)).ToList();
        ...
        public ActionResult Details(Guid id, bool partial = true, bool json = false)
        {
            ...
            else
            {
                ...
                {
                    var m = r.Data;
                    var vm = new T_UploadViewModel(m, true);
        ...
        {
            var routeFilter = GetRouteFilter();
            var vm = routeFilter != null ? new T_UploadViewModel(routeFilter) : new T_UploadViewModel() { };
        ...
        public ActionResult Create(T_UploadViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(T_UploadViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(T_UploadViewModel vm, bool json = false)
        {
            string message;
