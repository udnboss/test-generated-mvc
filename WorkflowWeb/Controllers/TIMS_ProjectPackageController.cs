...
namespace WorkflowWeb.Controllers
{
    ...
    {
        private TIMS_ProjectPackage _routeFilter;
        public TIMS_ProjectPackage RouteFilter
        {
            get
            {
        ...
        public List<TIMS_ProjectPackageViewModel> GetList()
        {
            ...
            var results = data.ToList().Select(x => new TIMS_ProjectPackageViewModel(x, true)).ToList();
