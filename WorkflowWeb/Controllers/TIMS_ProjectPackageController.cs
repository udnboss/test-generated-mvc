    ...
    public partial class TIMS_ProjectPackageController : BaseController<TIMS_ProjectPackage, TIMS_ProjectPackageBusiness, TIMS_ProjectPackageViewModel>
    {
        ...
        public Dictionary<string, object> DefaultGetLookups()
        {
            ...
            return new Dictionary<string, object> {
				...
				{"ProjectContractorID", db.TIMS_ProjectContractor.Where(x => routeFilter.ProjectContractorID == null || x.ID == routeFilter.ProjectContractorID).Select(x => new  SelectListItem { Value = x.ID.ToString(), Text = x.Name.ToString() }) }
            };
        }
        ...
        public ActionResult List(Guid? id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_ProjectPackageViewModel(x, true)).ToList();
        ...
        {
            var routeFilter = GetRouteFilter();
            var vm = routeFilter != null ? new TIMS_ProjectPackageViewModel(routeFilter) : new TIMS_ProjectPackageViewModel() { };
        ...
        public ActionResult Create(TIMS_ProjectPackageViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_ProjectPackageViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_ProjectPackageViewModel vm, bool json = false)
        {
            string message;
