...
{
    public class TIMS_ProjectAttachmentController : BaseController<TIMS_ProjectAttachment, TIMS_ProjectAttachmentBusiness, TIMS_ProjectAttachmentViewModel>
    {
        ...
        public override Dictionary<string, object> GetLookups()
        {
            return new Dictionary<string, object> {
				...
				{"PackageID", db.TIMS_ProjectPackage.Select(x => new  SelectListItem { Value = x.ID.ToString(), Text = x.Name.ToString() }) },
