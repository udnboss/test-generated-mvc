...
namespace WorkflowWeb.Controllers
{
    public class TIMS_ProjectAttachmentController : BaseController
    {
        ...
        public List<TIMS_ProjectAttachmentViewModel> GetList()
        {
            ...
            var data = db.TIMS_ProjectAttachment.Include(x => x.TIMS_ProjectInterfacePointWorkflow)
        ...
        public ActionResult Edit(Guid id)
        {
            ...
            var vm = new TIMS_ProjectAttachmentViewModel(m);
            ViewBag.Lookups = GetLookups();
        ...
        public ActionResult Create(TIMS_ProjectAttachmentViewModel vm)
        {
            if (ModelState.IsValid)
            {
                var m = vm.ToModel();
                m.ID = Guid.NewGuid(); 
                db.TIMS_ProjectAttachment.Add(m);
                db.SaveChanges();
                return List(m.ID);
            }
        ...
        public ActionResult Delete(TIMS_ProjectAttachmentViewModel vm)
        {
            if (ModelState.IsValid)
            {
                ...
                db.TIMS_ProjectAttachment.Remove(em);
                db.SaveChanges();
