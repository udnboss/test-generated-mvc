...
{
    public class TIMS_ProjectPhysicalAreaController : BaseController<TIMS_ProjectPhysicalArea, TIMS_ProjectPhysicalAreaBusiness, TIMS_ProjectPhysicalAreaViewModel>
    {
