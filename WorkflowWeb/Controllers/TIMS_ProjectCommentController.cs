...
namespace WorkflowWeb.Controllers
{
    public class TIMS_ProjectCommentController : BaseController
    {
        public List<TIMS_ProjectCommentViewModel> GetList()
        {
            ...
            var data = db.TIMS_ProjectComment.Include(x => x.TIMS_ProjectInterfacePointWorkflow)
        ...
        public ActionResult Edit(Guid id)
        {
            ...
            var vm = new TIMS_ProjectCommentViewModel(m);
            ViewBag.Lookups = GetLookups();
        ...
        public ActionResult Delete(TIMS_ProjectCommentViewModel vm)
        {
            if (ModelState.IsValid)
            {
                ...
                db.TIMS_ProjectComment.Remove(em);
                db.SaveChanges();
