...
namespace WorkflowWeb.Controllers
{
    public partial class TIMS_ProjectController : BaseController<TIMS_Project, TIMS_ProjectBusiness, TIMS_ProjectViewModel>
    {
        ...
        public ActionResult Create(TIMS_ProjectViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_ProjectViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_ProjectViewModel vm, bool json = false)
        {
            string message;
