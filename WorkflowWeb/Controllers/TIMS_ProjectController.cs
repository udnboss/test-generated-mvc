...
namespace WorkflowWeb.Controllers
{
    ...
    {
        public List<TIMS_ProjectViewModel> GetList()
        {
            db.Configuration.ProxyCreationEnabled = false;
            var data = db.TIMS_Project.AsQueryable();
            ...
            return data.ToList().Select(x => new TIMS_ProjectViewModel(x, true)).ToList();
        }

        public TIMS_Project Get(Guid id)
        {
            db.Configuration.ProxyCreationEnabled = false;
            return db.TIMS_Project.FirstOrDefault(x=> x.ID == id);
        }
        ...
        {
            var vm = new TIMS_ProjectViewModel() {  };
        ...
        public ActionResult Edit(Guid id)
        {
            ...
            var vm = new TIMS_ProjectViewModel(m);
            ViewBag.Lookups = GetLookups();
