...
{
    public partial class TIMS_PhaseController : BaseController<TIMS_Phase, TIMS_PhaseBusiness, TIMS_PhaseViewModel>
    {
        public TIMS_PhaseController()
        {
            business = new TIMS_PhaseBusiness(db, user);
        ...
        public ActionResult List(String id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_PhaseViewModel(x, true)).ToList();
        ...
        public ActionResult Create(TIMS_PhaseViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_PhaseViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_PhaseViewModel vm, bool json = false)
        {
            string message;
