...
{
    public partial class TIMS_ProjectAreaController : BaseController<TIMS_ProjectArea, TIMS_ProjectAreaBusiness, TIMS_ProjectAreaViewModel>
    {
        ...
        public ActionResult List(Guid? id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_ProjectAreaViewModel(x, true)).ToList();
        ...
        public ActionResult Create(TIMS_ProjectAreaViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_ProjectAreaViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_ProjectAreaViewModel vm, bool json = false)
        {
            string message;
