...
namespace WorkflowWeb.Controllers
{
    public partial class TIMS_ProjectInterfaceAgreementWorkflowController : BaseController<TIMS_ProjectInterfaceAgreementWorkflow, TIMS_ProjectInterfaceAgreementWorkflowBusiness, TIMS_ProjectInterfaceAgreementWorkflowViewModel>
    {
        ...
        public ActionResult Create(TIMS_ProjectInterfaceAgreementWorkflowViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_ProjectInterfaceAgreementWorkflowViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_ProjectInterfaceAgreementWorkflowViewModel vm, bool json = false)
        {
            string message;
