...
{
    public partial class TIMS_RoleController : BaseController<TIMS_Role, TIMS_RoleBusiness, TIMS_RoleViewModel>
    {
        public TIMS_RoleController()
        {
            business = new TIMS_RoleBusiness(db, user);
        ...
        public ActionResult List(Guid? id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_RoleViewModel(x, true)).ToList();
        ...
        public ActionResult Create(TIMS_RoleViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_RoleViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_RoleViewModel vm, bool json = false)
        {
            string message;
