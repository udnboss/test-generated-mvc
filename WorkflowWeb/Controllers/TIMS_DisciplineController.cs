...
namespace WorkflowWeb.Controllers
{
    public partial class TIMS_DisciplineController : BaseController<TIMS_Discipline, TIMS_DisciplineBusiness, TIMS_DisciplineViewModel>
    {
        ...
        public ActionResult Create(TIMS_DisciplineViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_DisciplineViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_DisciplineViewModel vm, bool json = false)
        {
            string message;
