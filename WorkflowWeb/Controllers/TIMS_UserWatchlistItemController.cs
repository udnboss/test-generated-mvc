...
{
    public partial class TIMS_UserWatchlistItemController : BaseController<TIMS_UserWatchlistItem, TIMS_UserWatchlistItemBusiness, TIMS_UserWatchlistItemViewModel>
    {
        ...
        public ActionResult Create(TIMS_UserWatchlistItemViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_UserWatchlistItemViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_UserWatchlistItemViewModel vm, bool json = false)
        {
            string message;
