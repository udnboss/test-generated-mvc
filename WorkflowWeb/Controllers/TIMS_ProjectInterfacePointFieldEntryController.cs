...
namespace WorkflowWeb.Controllers
{
    public partial class TIMS_ProjectInterfacePointFieldEntryController : BaseController<TIMS_ProjectInterfacePointFieldEntry, TIMS_ProjectInterfacePointFieldEntryBusiness, TIMS_ProjectInterfacePointFieldEntryViewModel>
    {
        ...
        public ActionResult List(Guid? id = null, string ui_list_view = null, bool json = false)
        {
            ...
            {
                var data = results.Data.Select(x => new TIMS_ProjectInterfacePointFieldEntryViewModel(x, true)).ToList();
        ...
        public ActionResult Create(TIMS_ProjectInterfacePointFieldEntryViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_ProjectInterfacePointFieldEntryViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_ProjectInterfacePointFieldEntryViewModel vm, bool json = false)
        {
            string message;
