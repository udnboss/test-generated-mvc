...
namespace WorkflowWeb.Controllers
{
    public partial class TIMS_WorkflowStateController : BaseController<TIMS_WorkflowState, TIMS_WorkflowStateBusiness, TIMS_WorkflowStateViewModel>
    {
        ...
        public ActionResult Create(TIMS_WorkflowStateViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(TIMS_WorkflowStateViewModel vm, bool json = false)
        {
            string message;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(TIMS_WorkflowStateViewModel vm, bool json = false)
        {
            string message;
